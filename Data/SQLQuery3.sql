...
INSERT INTO Table_USA (Cust_Name, Cust_ID, Open_Dt, Consul_Dt, VAC_ID, DR_Name, State, Country, DOB, FLAG, Age, Days_Since_Last_Consulted)
SELECT 
...
CREATE PARTITION FUNCTION OpenDatePartition_USA (DATE)
AS RANGE LEFT FOR VALUES ('2020-01-01', '2021-01-01', '2022-01-01');

CREATE PARTITION SCHEME OpenDateScheme_USA
AS PARTITION OpenDatePartition_USA TO ([PRIMARY], [PRIMARY], [PRIMARY], [PRIMARY]);

DROP COLUMN SCHEME opendatescheme